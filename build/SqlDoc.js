...
var SqlDoc = React.createClass({
    ...
    decryptDocument: function decryptDocument() {
    ...
    renderEncryptionDialog: function renderEncryptionDialog() {
        return React.createElement(
            'div',
            null,
            'The document is encrypted. Please enter the encryption key to view it:',
            React.createElement('input', { ref: function (item) {
                    this.encryptionKeyField = ReactDOM.findDOMNode(item);
                }.bind(this),
