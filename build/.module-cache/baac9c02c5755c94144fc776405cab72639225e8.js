...
var SqlDoc = React.createClass({displayName: "SqlDoc",
    ...
    render: function(){
        ...
        // charts pre script
        var prescript = '<script>charts_data.' + chart_id + ' = ' + dataset + ' </script>';

        return(

            React.createElement("div", {"data-id": chart_id, dangerouslySetInnerHTML: {__html: script}})
    ...
    renderChart: function(dataset, i, query){
        ...
        var script = '<script>charts_data.' + chart_id + ' = ' + dataset + ' </script>';
